...
- Hook `authorize` berjalan sebelum parsing query/body. T-06 akan memasang Origin/header dan sesi nyata; fondasi ini tidak mengklaim autentikasi sudah tersedia. Tidak ada CORS permisif.
